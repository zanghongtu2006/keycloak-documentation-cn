...
:upgradingguide_name: 升級指南
:upgradingguide_name_short: 升級
...
:installguide_name: 安装和配置指南
:installguide_name_short: 安装
...
:installguide_clustering_name: 集群
:installguide_clustering_link: {installguide_link}#_clustering
:installguide_database_name: 数据库
...
:installguide_loadbalancer_name: 负载均衡和代理
...
:installguide_troubleshooting_name: 故障诊断
